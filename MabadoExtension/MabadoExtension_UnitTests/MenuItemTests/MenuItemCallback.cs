...
using Reopened.MabadoExtension;

namespace MabadoExtension_UnitTests.MenuItemTests
{
    [TestClass()]
    [Ignore]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new MabadoExtensionPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Reopened.MabadoExtension.GuidList.guidMabadoExtensionCmdSet, (int)Reopened.MabadoExtension.PkgCmdIDList.cmdOpenSolution);
        ...
        {
            // Create the package
            IVsPackage package = new MabadoExtensionPackage();
            Assert.IsNotNull(package, "The object does not implement IVsPackage");
            ...
            MethodInfo info = package.GetType().GetMethod("ConnectToLabMenuItemCallback", BindingFlags.Instance | BindingFlags.NonPublic);
